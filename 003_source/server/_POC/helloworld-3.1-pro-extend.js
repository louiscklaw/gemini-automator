...
async function runSanityTest() {
  ...
  try {
    ...
    const config = selectorsData["3.1 pro-extend"]; 
    ...
    // Critical Fix: Use force: true to avoid timeout/enabled issues
